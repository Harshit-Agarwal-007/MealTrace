    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gray-50 px-4 py-8">
      <div className="w-full max-w-sm space-y-6">
        ...
        {sent ? (
          ...
          <form className="bg-white px-6 py-8 shadow-xl shadow-gray-200/50 rounded-2xl border border-gray-100 space-y-6">
             <div className="space-y-1">
              ...
              <button
                ...
                className="w-full flex justify-center items-center py-2.5 px-4 rounded-xl shadow-md shadow-indigo-600/30 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] transition-all"
              >
                Send Reset Link
              </button>
          </form>
